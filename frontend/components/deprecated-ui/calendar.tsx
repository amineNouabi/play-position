...
function getTheme(
  ...
  if (isThemeDark) {
    return {
      ...
      selectedDayBackgroundColor: NAV_THEME.dark.background,
      selectedDayTextColor: NAV_THEME.dark.primary,
  ...
  return {
    ...
    selectedDayBackgroundColor: NAV_THEME.light.background,
    selectedDayTextColor: NAV_THEME.light.primary,
